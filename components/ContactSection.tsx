  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 bg-slate-900/50">
      <div className="container mx-auto px-6">
        ...
        <div 
          className={`max-w-2xl mx-auto bg-slate-800 p-8 rounded-xl border border-slate-700 transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          style={{
